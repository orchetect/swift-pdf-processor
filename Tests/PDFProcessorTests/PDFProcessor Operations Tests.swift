//
//  PDFProcessor Operations Tests.swift
...
@Suite
struct PDFProcessorOperationsTests {
    @Test
    func newFile() throws {
        let tool = PDFProcessor()
    ...
    @Test
    func removeFileAttributes() throws {
        let tool = PDFProcessor()
        ...
        try expectPageIsEqual(
            #require(tool.pdfs[0].doc.page(at: 0)),
            #require(testPDF1Page_withAttrAnno().page(at: 0)),
    ...
    func extractPlainText() throws {
        ...
        try tool.load(pdfs: [
            #require(PDFDocument(url: TestResource.loremIpsum.url()))
        ])
    ...
    @Test
    func removeProtections() throws {
        // note: PDF password is "1234"

        let tool = PDFProcessor()

        try tool.load(pdfs: [
            #require(PDFDocument(url: TestResource.permissions.url()))
        ])
...
extension PDFProcessorOperationsTests {
