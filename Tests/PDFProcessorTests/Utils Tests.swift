...
struct CGRectTests {
    ...
    @Test
    func testRotate90Degrees_ZeroOrigin_CommonOrigin() {
    ...
    @Test
    func testRotate90Degrees_ZeroOrigin_Absolute_360() {
        let area = CGRect(x: 0, y: 0, width: 10, height: 13)
        let rect = CGRect(x: 3, y: 4, width: 6, height: 7)
    ...
    @Test
    func testRotate90Degrees_NonZeroOrigin_CommonOrigin() {
        let ox: CGFloat = 2
        let oy: CGFloat = 6
    ...
    @Test
    func testRotate90Degrees_NonZeroOrigin_Absolute_360() {
        let ox: CGFloat = 2
        let oy: CGFloat = 6
        let area = CGRect(x: ox, y: oy, width: 10, height: 13)
        let rect = CGRect(x: ox + 3, y: oy + 4, width: 6, height: 7)
    ...
    @Test
    func testRotate90Degrees_ZeroOrigin_Relative() {
        let area = CGRect(x: 0, y: 0, width: 10, height: 13)
        let rect = CGRect(x: 3, y: 4, width: 6, height: 7)
    ...
    @Test
    func testRotate90Degrees_ZeroOrigin_Relative_360() {
        let area = CGRect(x: 0, y: 0, width: 10, height: 13)
        let rect = CGRect(x: 3, y: 4, width: 6, height: 7)
    ...
    @Test
    func testRotate90Degrees_NonZeroOrigin_Relative() {
        let ox: CGFloat = 2
        let oy: CGFloat = 6
        let area = CGRect(x: ox, y: oy, width: 10, height: 13)
        let rect = CGRect(x: 3, y: 4, width: 6, height: 7)
    ...
    @Test
    func testRotate90Degrees_NonZeroOrigin_Relative_360() {
        let ox: CGFloat = 2
        let oy: CGFloat = 6
        let area = CGRect(x: ox, y: oy, width: 10, height: 13)
        let rect = CGRect(x: 3, y: 4, width: 6, height: 7)
